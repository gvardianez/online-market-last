...
public class KafkaProducerConfig {
  ...
  public KafkaTemplate<String, UserProfileDto> userProfileDtoKafkaTemplate() {
    KafkaTemplate<String, UserProfileDto> template =
        new KafkaTemplate<>(userProfileDtoProducerFactory());
  ...
  public KafkaTemplate<String, RecoverPasswordRequestDto> recoverPasswordDtoKafkaTemplate() {
    KafkaTemplate<String, RecoverPasswordRequestDto> template =
        new KafkaTemplate<>(recoverPasswordDtoProducerFactory());
    template.setMessageConverter(new StringJsonMessageConverter());
    return template;
  }
}
